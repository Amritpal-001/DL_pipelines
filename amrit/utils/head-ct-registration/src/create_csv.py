...
from amrit.validation.misc_utils import SITKDatasetSqlite
...
if __name__=='main':
    ...
    dcm_table = pd.read_csv('/home/users/mayug.maniparambil/head_ct/hemorrhages/new/fractures-2/amrit/validation/features_table_nlp_test_any_crop.csv')
